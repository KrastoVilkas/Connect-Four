document.addEventListener('DOMContentLoaded', () => {
  ...
  //check the board for win or lose state
  function checkBoard() {
    //make const that shows all winning arrarys
    const winningArrays = [
      [0, 1, 2, 3],
      [41, 40, 39, 38],
      [7, 8, 9, 10],
    ...
    for (let y = 0; y < winningArrays.length; y++) {
      ...
      if (square1.classList.contains('player-one') &&
        ...
        //if all true, player-one wins
        result.innerHTML = 'Player One Wins!!!'
      }

      //check arrays to see if they all have the class of player-two
